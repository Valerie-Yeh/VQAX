...
def load_model():
    model_path = 'ckpts/VQAX/revexpl_model_5'
    tokenizer_path = 'ckpts/VQAX/nle_gpt2_tokenizer'
...
class VQAXEvalDataset(Dataset):
    ...
    def __getitem__(self, i):
        ...
        segment_ids = [a_segment_id] * len(token_a)
...
aokvqa_val_data = AOKVQADataset(path = le_data,
                                transform = img_transform,
                                tokenizer = tokenizer,
                                max_seq_len = max_seq_len)


aokvqa_val_loader = torch.utils.data.DataLoader(aokvqa_val_data,
                                                batch_size = 1,
                                                shuffle=False,
                                                pin_memory=True)

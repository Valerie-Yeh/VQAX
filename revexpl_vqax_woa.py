...
def load_checkpoint(ckpt_path, epoch):
    ...
    model_name = 'VQAX_bf/revexpl_model_{}'.format(str(epoch))
    tokenizer_name = 'VQAX_bf/nle_gpt2_tokenizer'
    filename = 'VQAX_bf/ckpt_stats_' + str(epoch) + '.tar'
...
def save_checkpoint(epoch, unwrapped_model, optimizer, tokenizer, scheduler, ckpt_path, **kwargs):
    ...
    model_name = 'VQAX_woa/revexpl_model_{}'.format(str(epoch))
    tokenizer_name = 'VQAX_woa/nle_gpt2_tokenizer'
    filename = 'VQAX_woa/ckpt_stats_' + str(epoch) + '.tar'
